...
#define APP_PROTECT_MPU_FLASHEXE_1_B     MPU_ACCESS_NOT_BUFFERABLE
#define APP_PROTECT_MPU_FLASHEXE_1_C     MPU_ACCESS_CACHEABLE
...
#define APP_PROTECT_MPU_FLASHEXE_2_B     MPU_ACCESS_NOT_BUFFERABLE
#define APP_PROTECT_MPU_FLASHEXE_2_C     MPU_ACCESS_CACHEABLE
