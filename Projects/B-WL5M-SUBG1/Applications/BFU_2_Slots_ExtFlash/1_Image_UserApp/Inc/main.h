...
#define BUTTON_INIT()         BSP_PB_Init(BUTTON_USER1,BUTTON_MODE_GPIO);
#define BUTTON_PUSHED()      (BSP_PB_GetState(BUTTON_USER1) == GPIO_PIN_RESET)
#define BUTTON_INIT_EXTI()    BSP_PB_Init(BUTTON_USER1, BUTTON_MODE_EXTI)
#define BUTTON_IRQHANDLER     EXTI0_IRQHandler
#define BUTTON_EXTI_LINE      BUTTON_USER1_PIN
