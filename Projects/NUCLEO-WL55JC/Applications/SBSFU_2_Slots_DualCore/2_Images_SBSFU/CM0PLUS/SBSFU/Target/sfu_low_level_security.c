...

{
  /* Aliases Region and all User Flash & internal RAM */
  {
    ...
    SFU_PROTECT_MPU_AREA_USER_C,     SFU_PROTECT_MPU_AREA_USER_B
  },
  ...
  /* install header : read /write only for privileged */
  {
    ...
    SFU_PROTECT_MPU_HEADER_C, SFU_PROTECT_MPU_HEADER_B
  },
  ...
  /*  Flash execution */
  {
    ...
    SFU_PROTECT_MPU_FLASHEXE_C, SFU_PROTECT_MPU_FLASHEXE_B
  },
  ...
  /*  Flash execution */
  {
    ...
    SFU_PROTECT_MPU_FLASHEXE_ADJUST_C, SFU_PROTECT_MPU_FLASHEXE_ADJUST_B
  },
  ...
  /* KMS_DataStorage: NVM storage */
  {
    ...
    SFU_PROTECT_MPU_KMS_C, SFU_PROTECT_MPU_KMS_B
  },
  ...
  /* DMA */
  {
    ...
    SFU_PROTECT_MPU_DMA_C, SFU_PROTECT_MPU_DMA_B
  },
#endif /* SFU_DMA_PROTECT_ENABLE */
  /*  peripheral  */
  {
    ...
    SFU_PROTECT_MPU_PERIPH_1_C, SFU_PROTECT_MPU_PERIPH_1_B
  }
};
#endif /* SFU_MPU_PROTECT_ENABLE */
