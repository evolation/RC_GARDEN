...
#define APP_PROTECT_MPU_FLASHEXE_ADJUST_B     MPU_ACCESS_NOT_BUFFERABLE
#define APP_PROTECT_MPU_FLASHEXE_ADJUST_C     MPU_ACCESS_CACHEABLE
...
#define APP_PROTECT_MPU_FLASHEXE_ADJUST2_B     MPU_ACCESS_NOT_BUFFERABLE
#define APP_PROTECT_MPU_FLASHEXE_ADJUST2_C     MPU_ACCESS_CACHEABLE
